...
style.textContent = `
  ...
  * { box-sizing: border-box; }
  ...
  [data-theme="dark"] {
    ...
    --input-bg: #2A2244;
    --blue-soft: rgba(124,92,255,0.18);
  }
  ...
  .desktop-wallpaper {
    ...
    width: 100%;
    background:
      radial-gradient(ellipse 90% 60% at 15% 0%, #8B4A6B 0%, transparent 55%),
      radial-gradient(ellipse 80% 70% at 100% 100%, #C97A7A 0%, transparent 50%),
      linear-gradient(155deg, #2C1F52 0%, #4A3178 55%, #8B4A6B 100%);
    display: flex;
    flex-wrap: wrap;
  ...
  .badge-android { background: linear-gradient(160deg, #6FD97F, #3FB84F); }
  .badge-ios { background: linear-gradient(160deg, #6FB8F5, #3F8FF0); }
  .badge-admin { background: linear-gradient(160deg, #C9A6F0, #9D6DE0); }
  .badge-info { background: linear-gradient(160deg, #FFCC80, #FFA63F); }
